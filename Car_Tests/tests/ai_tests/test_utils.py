"""
Shared utilities for AI Vehicle Detection Tests
...
def filter_vehicles(objects):
    return [obj for obj in objects if obj.name.lower() in ['car', 'truck' ]]
...
def create_json_output(test_id, people_detected, output_files, timing_info=None, expected_count=None, test_passed=None):
    ...
    Args:
        ...
        people_detected: List of detected vehicle objects
        output_files: Dictionary of output file paths
        timing_info: Optional dictionary with start_time, end_time, duration
        expected_count: Expected number of vehicles in the image
